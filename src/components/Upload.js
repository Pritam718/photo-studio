  ...
  return (
    ...
    <div className="h-screen w-full lg:overflow-auto bg-no-repeat bg-cover bg-fixed bg-[url('Images/bg2.webp')]">
        ...
        <div class="flex items-center">
         ...
         <div className='flex justify-center items-center lg:py-4 lg:px-12 px-2'>
            <h1 className='text-xl'>Join our community of creators and showcase your talent by uploading your media!</h1>
         </div>
         <form className='lg:py-5' onSubmit={handleSubmit}>
            <div className='lg:flex lg:justify-center lg:gap-20 lg:py-2 px-2'>
                <input 
                    type='text' 
                    placeholder='Give a Title' 
                    className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block lg:w-1/4 w-full  lg:p-2.5 p-2 lg:hover:scale-110 hover:scale-105 my-1'
                    name='title'
                ...
                <input 
                    ...
                    className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block lg:w-1/4 w-full lg:p-2.5 p-2 lg:hover:scale-110 hover:scale-105'
                    name='caption'
                    //value='caption'
